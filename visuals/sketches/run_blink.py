"""Run the blink lights sketch.

Usage:
    python -m visuals.sketches.run_blink [--bpm 120] [--midi-port 0] [--virtual-midi]
"""

import argparse
from visuals.engine import Engine
from visuals.sketches import blink


def main():
    parser = argparse.ArgumentParser(description="Blink lights visualization")
