"""Run the constellation lights sketch.

Usage:
    python -m visuals.sketches.run_constellation [--bpm 120] [--midi-port 0] [--virtual-midi]
"""

import argparse
from visuals.engine import Engine
from visuals.sketches import constellation


def main():
    parser = argparse.ArgumentParser(description="Constellation lights visualization")
    ...
    engine.load_sketch(constellation)
    engine.run()
